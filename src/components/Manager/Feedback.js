        ...
        <Box sx={{ display: 'flex', bgcolor: 'white' }}>
            <Box
                sx={{
                    ...
                    p: 3,
                    bgcolor: 'white',
                    backgroundImage: 'linear-gradient(to right, #cbd5e1, #64748b)', // Corresponds to the gradient bg-gradient-to-r from-slate-300 to-slate-500
                    borderRadius: 2,
                }}
            >
                <Paper elevation={3} sx={{ padding: 3, maxWidth: '600px', mx: 'auto', borderRadius: 2 }}>
